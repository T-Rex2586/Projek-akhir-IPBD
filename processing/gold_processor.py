"""
Modul Pemrosesan Lapisan Emas (Gold Layer Processor).
Secara periodik menghitung dan mengagregasi metrik bisnis krusial yang mengonsolidasikan
data harga dan sentimen dari Lapisan Perak ke dalam interval waktu spesifik.
"""
import time
import os
import sys
...
class GoldLayerProcessor:
    """Manajer pemrosesan data untuk perumusan Lapisan Emas."""
    ...
    def run_cycle(self):
        """Mengeksekusi satu siklus konsolidasi untuk 6 jam ke belakang."""
        ...
        logger.info("gold_processing_cycle_completed", total_attempted=processed_count, successful=success_count)
        metrics.increment("gold_runs")

    def _check_divergence_alert(self, symbol: str):
        """Mengevaluasi divergensi sentimen-harga dan mengirimkan notifikasi Telegram jika diperlukan."""
        ...
        try:
            ...
            if divergence > 1.5:
                save_anomaly_event({
                    ...
                    "symbol": symbol,
                    "description": f"Divergensi Bearish terdeteksi! Harga Z: {price_z:.2f}, Sentimen Z: {sent_z:.2f}",
                    "severity": "high",
                ...
                save_anomaly_event({
                    ...
                    "symbol": symbol,
                    "description": f"Divergensi Bullish terdeteksi! Harga Z: {price_z:.2f}, Sentimen Z: {sent_z:.2f}",
                    "severity": "high",
                    "value": float(divergence),
                    "threshold": -1.5
                }, send_alert=True)
    ...
    def start_loop(self):
        """Menjalankan loop evaluasi prosesor secara kontinu."""
